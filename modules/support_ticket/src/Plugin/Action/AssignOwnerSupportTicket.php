 ...
 *
 * @Action(
 *   id = "support_ticket_assign_owner_action",
 *   label = @Translation("Change the author of ticket"),
 *   type = "support_ticket"
 * )
 */
class AssignOwnerSupportTicket extends ConfigurableActionBase implements ContainerFactoryPluginInterface {
  ...
  /**
   * Constructs a new AssignOwnerSupportTicket action.
   *
