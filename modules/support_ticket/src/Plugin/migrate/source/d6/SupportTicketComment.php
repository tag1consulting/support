...
/**
 * @file
 * Contains \Drupal\support_ticket\Plugin\migrate\source\d6\SupportTicketComment.
 */
 ...
 * )
 */
class SupportTicketComment extends DrupalSqlBase {
  ...
  public function query() {
    ...
    $query->innerJoin('support_ticket_comment', 'stc', 'c.cid = stc.cid');
    $query->innerJoin('support_states', 'ss', 'stc.state = ss.sid');
    $query->innerJoin('support_priority', 'sp', 'stc.priority = ss.pid');
