...
//    $ticket_type_storage->load('article')->delete();
  ...
  function testFailedTicketCreation() {
    ...
    if (Database::getConnection()->supportsTransactions()) {
      ...
      $node = $this->supportTicketGetTicketByTitle($edit['title']);
      $this->assertFalse($node, 'Transactions supported, and support_ticket not found in database.');
    }
    else {
      // Check that the node exists in the database.
      $node = $this->supportTicketGetTicketByTitle($edit['title']);
      $this->assertTrue($node, 'Transactions not supported, and support_ticket found in database.');
